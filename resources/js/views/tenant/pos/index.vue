      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="right-wrapper">
            <h2 class="text-sm pr-5">T/C <input type="text" style="width:45px;height:25px;border: 1px solid #39c;border-radius: 5px;padding: 5px;text-align:right;" v-model="form.exchange_rate_sale" /></h2>
      ...
      <div class="col-lg-4 col-md-6 bg-white m-0 p-0" style="height: calc(100vh - 110px)">
        ...
        <div class="h-25 bg-light" style="overflow-y: auto">
          ...
          <div
            ...
            @click="clickPayment"
            v-bind:class="[form.total > 0 ? 'bg-info pointer' : 'bg-dark']"
          >
