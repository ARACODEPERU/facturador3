                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center font-weight-bold" width="8%">Unidad</th>
                                                <th class="text-right font-weight-bold" width="9%">Cantidad</th>
                                                <th class="text-right font-weight-bold" width="10%">Precio Unitario</th>
                                                <th class="text-right font-weight-bold" width="9%">Subtotal</th>
                                                <!--<th class="text-right font-weight-bold" width="8%">Cargo</th>-->
                                                <th class="text-right font-weight-bold" width="8%">Total</th>
                                        ...
                                        <tbody v-if="form.items.length > 0">
                                            <tr v-for="(row, index) in form.items">
                                                ...
                                                <td class="text-center">
                                                     <a href="javascript:void(0);" @click.prevent="clickRemoveItem(index)"><span class="color-icons cross_co"></span></a>
                                                </td>
                                                <td class="text-center">
                                                    <a href="javascript:void(0);" @click="ediItem(row, index)" ><span class="color-icons application_edit_co"></span></a>
                                                </td>
                                            </tr>
