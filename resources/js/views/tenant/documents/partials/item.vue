                ...
                <div class="row">
                                ...
                                <el-input id="custom-input">
                                    <el-select :disabled="recordItem != null"
                                        ...
                                        <el-tooltip v-for="option in items"  :key="option.id" placement="top">
                                            ...
                                            <el-option  :value="option.id" :label="option.full_description" :disabled="option.stock <= 0"></el-option>
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="form-group" :class="{'has-danger': errors.unit_price_value}">
                            ...
                            <el-input v-model="form.unit_price_value" @input="calculateQuantity" :readonly="typeUser === ''" disabled>
